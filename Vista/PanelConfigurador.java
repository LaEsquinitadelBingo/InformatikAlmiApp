...
public class PanelConfigurador extends JPanel {
	...
	public PanelConfigurador(GestionComponentes g) {
		...
		btnReiniciar.setIcon(new ImageIcon("images/eliminar.png"));
		pnlBotones.add(btnReiniciar);
		
		btnCargar = new JButton("Cargar");
		btnCargar.setIcon(new ImageIcon("images/publicar.png"));
		pnlBotones.add(btnCargar);
		
		btnGuardar = new JButton("Guardar");
		btnGuardar.setIcon(new ImageIcon("images/me-gusta.png"));
		...
		lblImgProc.setIcon(new ImageIcon("images/procesador.png"));
		originales.add("images/procesador.png");
		...
		lblImgPlaca.setIcon(new ImageIcon("images/placa.png"));
		originales.add("images/placa.png");
		...
		lblImgCaja.setIcon(new ImageIcon("images/caja.png"));
		originales.add("images/caja.png");
		...
		lblImgFuente.setIcon(new ImageIcon("images/fuente.png"));
		originales.add("images/fuente.png");
		...
		lblImgVenti.setIcon(new ImageIcon("images/venti.png"));
		originales.add("images/venti.png");
		...
		lblImgGrafica.setIcon(new ImageIcon("images/grafica.png"));
		originales.add("images/grafica.png");
		...
		lblImgDD = new JLabel("");
		lblImgDD.setIcon(new ImageIcon("images/dd.png"));
		originales.add("images/dd.png");
	...
	public void añadir(Producto p) {
		...
		for (Producto pro:config) {
			...
			BufferedImage img;
			try {
				img = ImageIO.read(new File("images",pro.getFoto()));
