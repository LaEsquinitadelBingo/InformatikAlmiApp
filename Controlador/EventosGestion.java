...
public class EventosGestion {
    ...
    public void registrarEventos() {
		...
		gestion.getBtnFacturar().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					contenido.showText("TIKALMI");
					contenido.newLineAtOffset(0, -15);
					contenido.showText("Urreta Kalea, 1");
					contenido.newLineAtOffset(0, -15);
					...
					contenido.showText("Factura nº " + gestion.getNumPedido());
					contenido.endText();
		...
		gestion.getBtnCliente().addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				GestionClientes gc = new GestionClientes(gestion);
